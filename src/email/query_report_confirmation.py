...
@dataclass
class QueryReportConfirmation(EmailService):
    email_from = "alerts@nib-bahamas.com"
    email_to = []
    subject = "NIB Query Tool: Query Report Request"
    template_id = NIBEmailService.template_ids["query_report_accept.html"]
